...
// GradientButton 在 JiuFoundation 里，暂时用 VGGradientButton。

// 在 JiuFoundation 升级之后修改为 GradientButton。
public final class VGGradientButton: UIButton, GradientLayerSetter, GradientLayerView {
...
extension VGGradientButton: ColorStyleVisitor {
